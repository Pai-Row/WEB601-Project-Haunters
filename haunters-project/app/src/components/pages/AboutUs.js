...
const AboutUs = () => {
    return <div>
        ...
        <div class="google-maps"><div class="gmap_canvas"><iframe width="604" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=300%20Montobello%20Avenue&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>
